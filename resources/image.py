...
class Image(Resource):
    ...
    def get(self, filename: str):
        ...
        if not image_helper.is_filename_safe(filename):
            return {"message": gettext("image_wrong_file_name").format(filename)}, 400
        try:
    ...
    def delete(self, filename: str):
        ...
        try:
            ...
            traceback.print_exc()
            return {"message": gettext("image_delete_failed")}, 501
    ...
    def put(self):
        ...
        if avatar_path:
            try:
                ...
                return {"message": gettext("avatar_delete_failed")}, 501
        try:
            ...
            return {"message": gettext("avaar_uploaded").format(basename)}, 200
        except UploadNotAllowed:
            extension = image_helper.get_extension(data["image"])
            return {"message": gettext("image_wrong_extension").format(extension)}, 400
